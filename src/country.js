...
class Country extends Component{
    ...
    update=()=>{
        this.setState({loader:<i className="fa fa-cog fa-spin" />})
        if (document.getElementById("search").value===""){
            this.setState({value: alert("Enter in search bar "), loader:""})
        }
        else{
        ...
        if (pressed===false) {
            ...
            return (
                <div className="country">
                    ...
                    <br/>
                    <br/>
                    <Tab total={total} recover={recover} death={death} recorded={recorded}/>
                    <br/>
